    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אינפיניטי888 פתרונות אחסנה ומגורים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '4628d263-dfb9-4985-9e48-e34067778c76',
                    name: data.name || '',
                    email: data.email || '',
